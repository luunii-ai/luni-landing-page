...
const BeforeAfterSlider = ({
  ...
  return (
    <div
      ref={containerRef}
      className="relative h-full w-full min-h-0 cursor-col-resize select-none overflow-hidden rounded-xl bg-secondary/80 touch-none"
    ...
    >
      ...
      <div className="pointer-events-none absolute bottom-3 left-3 z-20 rounded-full bg-card px-3 py-1 text-xs font-medium text-foreground shadow-sm">
        {beforeLabel}
      </div>
