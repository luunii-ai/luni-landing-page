...
export function LegalDocumentView({ document, backHref = '/', backLabel = 'Voltar' }: Props) {
  return (
    <article className="mx-auto max-w-3xl px-6 py-16">
      ...
      <h1 className="text-3xl font-medium tracking-tight text-foreground md:text-4xl">{document.title}</h1>
